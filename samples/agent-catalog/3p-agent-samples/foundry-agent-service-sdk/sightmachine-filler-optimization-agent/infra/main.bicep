...
param aiHubName string = 'hub-filler'

@description('Friendly name for your Hub resource')
param aiHubFriendlyName string = 'Filler Agents Hub resource'

@description('Description of your Azure AI resource displayed in AI studio')
param aiHubDescription string = 'This is the FIller Agent resource for use in Azure AI Studio.'

@description('Name for the AI project resources.')
param aiProjectName string = 'project-filler'

@description('Friendly name for your Azure AI resource')
param aiProjectFriendlyName string = 'Filler Agent Project resource'

@description('Description of your Azure AI resource displayed in AI studio')
param aiProjectDescription string = 'This is the Filler Agent resource for use in Azure AI Studio.'
